...
PACKAGES="$PACKAGES kmod-gobinet"
...
PACKAGES="$PACKAGES kmod-mtk-pcie-wwan-m80"
...
PACKAGES="$PACKAGES minicom"
PACKAGES="$PACKAGES quectel-CM-5G"
PACKAGES="$PACKAGES fibocom-dial"
PACKAGES="$PACKAGES meig-cm"
